...
const myStorage = new _LocalStorage__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
const displayTaskDetails = (task) => {
  ...
  dompurify__WEBPACK_IMPORTED_MODULE_0___default().sanitize(taskDetailsPopup);
...
const editTask = () => {
  ...
  _LocalStorage__WEBPACK_IMPORTED_MODULE_1__["default"].updateStorage(myStorage.tasks);
...
const handleNavButtons = (button) => {
  ...
  if (navButtonText === 'Today') {
    tasksByDateArr = myStorage.tasks.filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(task.dueDate)));
    return displayTaskElements(tasksByDateArr);
  }

  if (navButtonText === 'This week') {
    tasksByDateArr = myStorage.tasks.filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(task.dueDate)));
    return displayTaskElements(tasksByDateArr);
  }
...
const isTaskInputValid = (title, dueDate) => {
  ...
  if ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(dueDate)) || !(0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(dueDate))) {
...
const clearTasksButtonEvent = (e) => {
  if (e.target.matches('#clear-task-button')) _LocalStorage__WEBPACK_IMPORTED_MODULE_1__["default"].clearStorage();
};
...
const addTaskPopupButtonEvent = (e) => {
  if (e.target.matches('.add-task-popup-button')) {
    ...
    if (isTaskInputValid(taskTitle, taskDate)) {
      myStorage.createTask(new _Task__WEBPACK_IMPORTED_MODULE_2__["default"](taskTitle, taskDescription, taskDate));
      displayTaskElements(myStorage.tasks);
    }
  }
};
...
class LocalStorage {
  ...
  getDefaultTask() {
    const defaultTask = new _Task__WEBPACK_IMPORTED_MODULE_0__["default"]('default', 'default', (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 'yyyy-MM-dd'), false);
    this.tasks = [];
