...
const myStorage = new _LocalStorage__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
const clearTasksButtonEvent = (e) => {
    if (e.target.matches('#clear-task-button')) _LocalStorage__WEBPACK_IMPORTED_MODULE_0__["default"].clearStorage();
};
...
const tasksCheckboxesEvent = (e) => {
    if (e.target.matches('.isChecked')) {
        ...
        _LocalStorage__WEBPACK_IMPORTED_MODULE_0__["default"].updateStorage(myStorage.tasks);
        displayTaskElements(myStorage.tasks, document.querySelector('.tasks-list'));
    }
};
...
function displayTaskDetails(task) {
    ...
    dompurify__WEBPACK_IMPORTED_MODULE_1___default().sanitize(taskDetailsPopup);
